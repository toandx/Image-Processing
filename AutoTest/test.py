...
paper = four_point_transform(im, docCnt.reshape(4, 2))
warped = four_point_transform(gray, docCnt.reshape(4, 2))
cv2.imwrite('catanh.jpg',paper)
...
temp=paper.copy()
cv2.drawContours(temp,questionCnts,-1,(0,0,255),3)
cv2.imwrite('xacdinhtron.jpg',temp)
